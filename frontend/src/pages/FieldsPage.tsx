...
export function FieldsPage() {
  ...
  return (
    <div className="shell page-section">
      <div className="page-heading reveal"><span className="kicker">Khám phá SportHub</span><h1>Tìm sân cho trận đấu tiếp theo.</h1><p>Lọc theo môn chơi, loại sân và ngân sách của bạn.</p></div>
      ...
      {fields.isPending ? (
        ...
        <div className="field-grid">{fields.data?.data.map((field, index) => <FieldCard field={field} index={index} key={field.id} />)}</div>
      )}
