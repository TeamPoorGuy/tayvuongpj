...
<body class="bg-slate-900 text-slate-100 flex h-screen overflow-hidden">
    ...
    <!-- Admin Sidebar -->
    <aside class="w-64 bg-slate-950 text-white flex flex-col border-r border-slate-800 flex-shrink-0">
    ...
    <!-- Main Content Area -->
    <div class="flex-grow flex flex-col overflow-y-auto bg-slate-900">
        <header class="bg-slate-950 border-b border-slate-800 h-16 flex items-center justify-between px-8 sticky top-0 z-10">
            <h1 class="text-lg font-bold text-white">@yield('page_title', 'Bảng Điều Khiển Quản Trị')</h1>
            <a href="{{ route('home') }}" class="text-xs text-indigo-400 font-semibold hover:underline">← Quay về Trang chủ</a>
        </header>
