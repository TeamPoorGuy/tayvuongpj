        ...
        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
            @foreach($profiles as $p)
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-750">
                    <td class="px-6 py-4 font-bold text-slate-900 dark:text-white">{{ $p->user->name }}</td>
                    <td class="px-6 py-4 font-semibold text-emerald-600 dark:text-emerald-400">{{ $p->business_name }}</td>
